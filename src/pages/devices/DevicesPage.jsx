...
export default function DevicesPage() {
  ...
  return (
    <section className="device-inventory-page">
      ...
      <div className="device-management-toolbar">{role === "ADMIN" && <PrimaryButton onClick={() => setDialog({ mode: "new" })}>Register Device</PrimaryButton>}{feedback && <p role="status">{feedback}</p>}</div>
        ...
        <>
          ...
          <div className="device-inventory-table-wrap">
            <table className="device-inventory-table">
              <thead><tr><th>Device</th><th>Type</th><th>Status</th><th>Heartbeat</th><th>Firmware</th><th>Project</th><th>Registration</th><th>Last communication</th><th>Tags</th><th>Location</th><th>Actions</th></tr></thead>
